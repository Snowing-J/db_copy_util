...
public class TestGenerator {
    ...
    public void testGenerator() {
        ...
        globalConfig.setAuthor("patrick")   // 输出路径"/Users/shijiarui/IdeaProjects/MyProject/db_copy_until/src/main/java"
                .setOutputDir("/---")//设置输出路径
        ...
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://localhost:3306/online_DB?serverTimezone=UTC")
                .setUsername("root").setPassword("123456Mysql");
        ...
        packageConfig.setParent("com.patrick.db_copy_until").setMapper("mapper")
